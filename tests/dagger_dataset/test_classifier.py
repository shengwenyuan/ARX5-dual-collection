...
from arx5_collection.dagger_dataset.classifier import classify_authority
from arx5_collection.dagger_dataset.models import AuthorityClass
from arx5_collection.dagger_dataset.models import AuthorityEventRecord
from arx5_collection.dagger_dataset.models import AuthorityEventType
from arx5_collection.dagger_dataset.store import classification_quality
from arx5_collection.dagger_dataset.store import segment_rows
...
def metadata(segments: list[dict[str, object]], interventions: int = 1) -> dict[str, object]:
    return {
...
class AuthorityClassifierTest(unittest.TestCase):
    def test_classifies_one_complete_correction_with_semantic_boundaries(self) -> None:
        result = classify_authority(normal_metadata(), normal_events())
    ...
    def test_incomplete_human_tail_is_audited_but_not_trainable(self) -> None:
        ...
        result = classify_authority(value, events)
    ...
    def test_rejects_event_and_metadata_disagreement(self) -> None:
        ...
        result = classify_authority(value, normal_events())
    ...
    def test_shadow_is_valid_but_has_no_authority_training_data(self) -> None:
        ...
        result = classify_authority(value, ())
