...
from arx5_collection.dataset_pipeline.mining_stage.dataset_generator.lerobot_fragment_generator.images import (
...
class ImageDecodeTest(unittest.TestCase):
    ...
    def test_rejects_invalid_historical_yuyv(self) -> None:
        with self.assertRaises(ValueError):
            decode_color_message(self.message("yuyv", b"", width=1, height=1, step=2))
