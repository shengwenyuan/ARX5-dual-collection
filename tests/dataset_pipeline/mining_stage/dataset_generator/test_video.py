...
class VideoEncodingConfigTest(unittest.TestCase):
    def test_dataset_entrypoints_pin_pyav_decoder(self) -> None:
        for path in (
            "src/arx5_collection/dataset_pipeline/mining_stage/dataset_generator/lerobot_fragment_generator/__init__.py",
            "src/arx5_collection/dataset_pipeline/mining_stage/dataset_generator/utils.py",
        ):
