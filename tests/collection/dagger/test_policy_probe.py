...
from arx5_collection.collection.dagger.policy_probe import run_rtc_policy_probe


CONFIG = Path(__file__).parents[3] / "config" / "collection" / "dagger.rtc.example.toml"
