...
from arx5_collection.collection.runtime.config import PedalConfig


VENDOR_DESCRIPTOR = bytes.fromhex("0600ff0900a1010900150026ff0075089540810609009106c0")
...
class PedalDeviceResolverTest(unittest.TestCase):
    ...
    def test_missing_member_is_unavailable(self) -> None:
        ...
        with self.assertRaisesRegex(PedalUnavailable, "trigger abort"):
            self.resolver().resolve(pedal("activate", "one"), pedal("abort", "two"))
