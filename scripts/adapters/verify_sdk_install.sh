...
python3 -c 'from arx5_collection.adapters.ros2 import RosStreamMonitor, RosbagRecordingBackend'
...
vendor_home=$(python3 -c 'from arx5_collection.collection.environment import ENVIRONMENT; print(f"go_home_position: {list(ENVIRONMENT.reset.home)}")')
