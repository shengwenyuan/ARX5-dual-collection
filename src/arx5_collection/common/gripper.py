...
from .specs import PI05_ARX5_SPEC


ARX5_GRIPPER_CONTRACT_ID = PI05_ARX5_SPEC.gripper.contract_id
ARX5_GRIPPER_OPEN_RAW = PI05_ARX5_SPEC.gripper.open_value
ARX5_GRIPPER_CLOSED_RAW = PI05_ARX5_SPEC.gripper.closed_value
ARX5_GRIPPER_OPEN_TOLERANCE = PI05_ARX5_SPEC.gripper.open_tolerance
ARX5_GRIPPER_CLOSED_TOLERANCE = PI05_ARX5_SPEC.gripper.closed_tolerance
