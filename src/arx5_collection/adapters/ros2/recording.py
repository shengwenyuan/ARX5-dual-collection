...
class RosbagRecordingBackend:
    def __init__(
        ...
        start_timeout_s: float = ENVIRONMENT.recording.start_timeout_s,
        stop_timeout_s: float = ENVIRONMENT.recording.stop_timeout_s,
        warning_ratio: float = ENVIRONMENT.recording.warning_ratio,
        ...
        self.readiness_probe = (
            ...
            if readiness_probe is not None
                ...
                _wait_for_recorder_subscriptions if recorder_factory is None else None
            )
        )
