...
PI05_IMAGE_WIDTH = PI05_ARX5_SPEC.dataset.image_width
PI05_IMAGE_HEIGHT = PI05_ARX5_SPEC.dataset.image_height
...
class Pi05Observation:
    ...
    def __post_init__(self) -> None:
        if len(self.state) != 14 or not all(
            math.isfinite(value) for value in self.state
        ):
