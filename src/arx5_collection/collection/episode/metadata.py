...
from arx5_collection.collection.metadata import CollectionType, MetadataContext
...
def build_metadata(
    ...
    if (
        len(metrics_by_id) != len(result.stream_metrics)
        or set(metrics_by_id) != stream_ids
    ):
