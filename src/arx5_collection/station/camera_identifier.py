...
CAMERA_BINDING_ORDER = ("left", "overview", "right")
...
class CameraIdentifier:
    def __init__(
        ...
        self.candidates = {candidate.serial_number: candidate for candidate in candidates}
...
class RealSenseStreamValidator:
    ...
    def __init__(self, rs_module: Any | None = None, frame_timeout_ms: int = 5000) -> None:
