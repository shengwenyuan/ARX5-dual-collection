...
class MovementDetector:
    def __init__(self, movement_threshold_rad: float = 0.05) -> None:
...
class ArmIdentifier:
    ...
    def identify(
        ...
        provisional = _ProvisionalStation(
            arms=(
                ArmConfig("left", ordered[0].serial_number, "can1"),
                ArmConfig("right", ordered[1].serial_number, "can3"),
            )
        )
        ...
        return (
            ArmConfig("left", left_serial, "can1"),
            ArmConfig("right", right_serial, "can3"),
        )
